...
export default function TableElement() {
    return (
        ...
        <tr className='table_element text-center justify-content-center align-items-center' >
          <td className=' justify-content-center align-items-center' id=''> <img width={80} height={50} src='https://th.bing.com/th/id/R.9e6636a3531d504311061164455c64c8?rik=oKC6LlRm2wn8vw&pid=ImgRaw&r=0'></img> <strong className='name'> Tên nhà </strong>  </td>
